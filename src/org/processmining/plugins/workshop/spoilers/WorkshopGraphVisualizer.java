...
public class WorkshopGraphVisualizer {
	 ...
	 */
	@Plugin(name = "Show Workshop Graph", returnLabels = { "Visualization of Workshop Graph" }, returnTypes = { JComponent.class }, parameterLabels = { "Workshop Graph" }, userAccessible = false)
	@Visualizer
